...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
  xmlns:m="http://rep.oio.dk/medcom.dk/xml/schemas/2021/06/06/">
              ...
              <tr>
                <td valign="top" width="100%">
                  <table>
                    ...
                    <tr>
                      <td>
                        <xsl:call-template name="Comment072"/>
                      </td>
                    </tr>
                    </xsl:for-each>
                  </table>
...
-->          
  ...
  <!--  cultureFindingsTableNS2007  Udkommenteres grundet dublet i 2010/07/01
    
  <xsl:template name="cultureFindingsTableNS2007">
