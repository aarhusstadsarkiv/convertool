      ...
      <td valign="top" width="100%" bgcolor="#ffffff" colspan="2">
        <table width="100%">
          <tbody>
            <tr>
              <xsl:call-template name="ShowMessageHeader">
                <xsl:with-param name="MessageName" select="'Øfeldthenvisning'"/>
              </xsl:call-template>
            </tr>
            <tr>
              <td valign="top" width="100%">
                ...
                <table>
                  <tbody>
                    <tr>
                      ...
                      <xsl:for-each select="m:AdditionalInformation/m:Accompanying">
                        <td valign="top">
                          <b>Ledsagelse:</b>
                        </td>
                        <td valign="top">
                      ...
                      <td valign="top" width="100%">
                        <table width="100%">
                          <tbody>
                            ...
                            <xsl:for-each select="m:RelevantClinicalInformation/m:Bones">
                              <tr>
                                <td>
                                  <b>Knogler</b>
                                </td>
