...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:m="http://rep.oio.dk/medcom.dk/xml/schemas/2017/02/17/" xmlns:gepj="http://medinfo.dk/epj/proj/gepka/20030701/xml/schema" xmlns:cpr="http://rep.oio.dk/cpr.dk/xml/schemas/core/2002/06/28/" xmlns:dkcc="http://rep.oio.dk/ebxml/xml/schemas/dkcc/2003/02/13/" xmlns:xs="http://www.w3.org/2001/XMLSchema">
				...
				<td valign="top" width="100%" bgcolor="#ffffff" colspan="2">
					<table width="100%">
						<tbody>
										...
										<tbody>
											...
											<tr>
												...
												<td valign="top"/>
													...
													<td>
														<xsl:if test="m:RequisitionInformation/m:Sample/m:OriginalSampleIdentifierType">
															<xsl:attribute name="title">
													    		<xsl:text>Nationalt Prøvenummer</xsl:text>
													  		</xsl:attribute>
													  	</xsl:if>
							...
							<xsl:for-each select="m:RequisitionInformation/m:SamplingLocation">
								<tr>
									<td valign="top" width="100%">
										<table>
											<tbody>
														...
														<tbody>
															...
															<xsl:for-each select="m:Requests/m:RequestedAnalysis">
																...
																<tr>
																	...
																	<td valign="top">
																		<xsl:value-of select="m:Analysis/m:SampleMaterialType"/>
																		<xsl:value-of select="m:Analysis/m:SampleMaterial"/>
																	</td>
															...
															<tbody>
																...
																<xsl:for-each select="m:Requests/m:Prompt">
																	...
																	<tr>
																		...
																		<td valign="top">
																			<xsl:value-of select="m:Question/m:Relation/m:AnalysisCode"/>
																			<xsl:value-of select="m:Question/m:Relation/m:SampleIdentifier"/>
																		</td>
																	</tr>
																</xsl:for-each>
															</tbody>
