								...
								<table>
									<tbody>
										<tr>
											...
											<xsl:for-each select="m:AdditionalInformation/m:HospitalChoice">
												<td valign="top">
													<b>Frit sygehusvalg:</b>
												</td>
												<td valign="top">
													<xsl:value-of select="."/>
												</td>
