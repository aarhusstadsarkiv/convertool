...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  xmlns:m="http://rep.oio.dk/medcom.dk/xml/schemas/2017/08/04/"
  ...
  <!-- ChiropracticLetter -->
  <xsl:template match="m:Emessage[m:ChiropracticLetter]">
    <xsl:for-each select="m:ChiropracticLetter">
      <td valign="top" width="100%" bgcolor="#ffffff" colspan="2">
        <table width="100%">
          <tbody>
            <tr>
              <xsl:call-template name="ShowMessageHeader">
                <xsl:with-param name="MessageName" select="'Kiropraktorepikrise'"/>
              </xsl:call-template>
            </tr>
            <tr>
