...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:m="http://rep.oio.dk/medcom.dk/xml/schemas/2019/03/31/" xmlns:gepj="http://medinfo.dk/epj/proj/gepka/20030701/xml/schema" xmlns:cpr="http://rep.oio.dk/cpr.dk/xml/schemas/core/2002/06/28/" xmlns:dkcc="http://rep.oio.dk/ebxml/xml/schemas/dkcc/2003/02/13/" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	<xsl:output media-type="text/html"/>

	<!-- 	EmergencyMunicipalityLetter -->
	<xsl:template match="m:Emessage[m:EmergencyMunicipalityLetter]">
		<xsl:for-each select="m:EmergencyMunicipalityLetter">
			<td valign="top" width="100%" bgcolor="#ffffff" colspan="2">
				<table width="100%">
					<tbody>
						<tr>
							<xsl:call-template name="ShowMessageHeader">
								<xsl:with-param name="MessageName" select="'Det gode afslutningsnotat fra kommunens akutfunktion'"/>
							</xsl:call-template>
						</tr>
						<tr>
	...
	<!--	EmergencyMunicipalityReferral -->
	<xsl:template match="m:Emessage[m:EmergencyMunicipalityReferral]">
		<xsl:for-each select="m:EmergencyMunicipalityReferral">
			<td valign="top" width="100%" bgcolor="#ffffff" colspan="2">
				<table width="100%">
					<tbody>
						<tr>
							<xsl:call-template name="ShowMessageHeader">
								<xsl:with-param name="MessageName" select="'Henvisning til kommunens akutfunktion'"/>
							</xsl:call-template>
						</tr>
