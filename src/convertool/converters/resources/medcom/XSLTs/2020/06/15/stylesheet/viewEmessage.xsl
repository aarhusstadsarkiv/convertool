...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:m="http://rep.oio.dk/medcom.dk/xml/schemas/2020/06/15/" xmlns:gepj="http://medinfo.dk/epj/proj/gepka/20030701/xml/schema" xmlns:cpr="http://rep.oio.dk/cpr.dk/xml/schemas/core/2002/06/28/" xmlns:dkcc="http://rep.oio.dk/ebxml/xml/schemas/dkcc/2003/02/13/" xmlns:xs="http://www.w3.org/2001/XMLSchema">
			...
			<td valign="top" width="100%" bgcolor="#ffffff" colspan="2">
				<table width="100%">
					<tbody>
						...
						<xsl:if test="count(m:ActionPriority)>0">
							<tr>
								<td valign="top" width="100%">
									<table>
										<tbody>
											...
											<tr>
												<td valign="top">
													<table>
														<tbody>
															<xsl:for-each select="m:ActionPriority">
																<tr>
																	<td valign="top">
																		<xsl:for-each select="m:ActionPriorityCode">
																			<xsl:apply-templates/>
																		</xsl:for-each>
																	</td>
																</tr>
						...
						<xsl:if test="count(m:RecommendedAction)>0">
							<tr>
								<td valign="top" width="100%">
									<table>
										<tbody>
											<tr>
												<td valign="top">
													<b>Anbefalet opbefalet opfølgning hos lægen</b>
												</td>
											</tr>
											<tr>
												<td valign="top">
													<table>
														<tbody>
															<xsl:for-each select="m:RecommendedAction">
																<tr>
																	<td valign="top">
																		<xsl:for-each select="m:Recommendation">
																			<xsl:apply-templates/>
																		</xsl:for-each>
																	</td>
																</tr>
