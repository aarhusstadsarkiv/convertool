...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
      ...
      <td valign="top" width="100%" bgcolor="#ffffff" colspan="2">
        <table width="100%">
          <tbody>
                    ...
                    <tr>
                      ...
                      <td valign="top">
                        <xsl:for-each
                          ...
                          <!-- Ikke som i microbiologi RPT02 (der er det under sample) -->
                          <xsl:call-template name="FormatDateTime"/>
                        </xsl:for-each>
                      </td>
                      <xsl:call-template name="ShowReqStatus_XR0531M"/>
                      <td valign="top">
                        <b>Prøvestatus:</b>
                      </td>
                      <td valign="top">
              ...
              <tr>
                <td valign="top" width="100%">
                  <table>
                    ...
                    <tr>
                      <td>
                        <xsl:call-template name="MicroReport_Comment_XR0531M"/>
                      </td>
                    </tr>
                    </xsl:for-each>
                  </table>
            ...
            <!-- Nedenstående findes ikke i strukturen -->
                  ...
                  <tbody>
                    <tr>
                      <td valign="top">
                        <b>
                          <xsl:value-of
                            select="m:LaboratoryResults/m:Investigation/m:MicroscopicFindings/m:Headline"/>
                        </b>
                      </td>
                    </tr>
                    <tr>
                      <td valign="top">
                        <xsl:apply-templates
                          select="m:LaboratoryResults/m:Investigation/m:MicroscopicFindings/m:Comments/text()|m:LaboratoryResults/m:Investigation/m:MicroscopicFindings/m:Comments/*"
                        />
                      </td>
                    </tr>
                  </tbody>
                  ...
                  <tbody>
                    <tr>
                      <td valign="top">
                        <b>
                          <xsl:value-of
                            select="m:LaboratoryResults/m:Investigation/m:CultureWithoutFindings/m:Headline"/>
                        </b>
                      </td>
                    </tr>
                    <tr>
                      <td valign="top">
                        <xsl:apply-templates
                          select="m:LaboratoryResults/m:Investigation/m:CultureWithoutFindings/m:Comments/text()|m:LaboratoryResults/m:Investigation/m:CultureWithoutFindings/m:Comments/*"
                        />
                      </td>
                    </tr>
                  </tbody>
                  ...
                  <tbody>
                    <tr>
                      <td valign="top">
                        <b>
                          <xsl:value-of
                            select="m:LaboratoryResults/m:Investigation/m:CultureWithFindings/m:Headline"/>
                        </b>
                      </td>
                    </tr>
                    <xsl:for-each select="m:LaboratoryResults/m:Investigation/m:CultureWithFindings/m:Microorganism">
                      <tr>
                        <td valign="top">
                          <table>
                            <tbody>
                    ...
                    <tr>
                      <xsl:for-each
                        select="m:LaboratoryResults/m:Investigation/m:CultureWithFindings/m:Pattern/m:PatternEntry[1]">
                        <tr>
                          <td valign="top">
                      ...
                      <td valign="top">
                        <table>
                          <tbody>
                            <tr>
                              <xsl:for-each
                                select="m:LaboratoryResults/m:Investigation/m:CultureWithFindings/m:Pattern/m:SensitivityInterpretation/text()">
                                <td valign="top">
                                  <xsl:value-of select="."/>
                                </td>
                              </xsl:for-each>
                    ...
                    <tr>
                      <td valign="top">
                        <xsl:apply-templates
                          select="m:LaboratoryResults/m:Investigation/m:CultureWithFindings/m:Comments/text()|m:LaboratoryResults/m:Investigation/m:CultureWithFindings/m:Comments/*"
                        />
                      </td>
                    </tr>
                  </tbody>
  ...
  <xsl:template name="MicroReport_Comment_XR0531M">
      ...
      <xsl:for-each select="m:Investigation">
        <xsl:element name="div">
          ...
          <xsl:for-each select="m:CultureFindings">
            <xsl:call-template name="MicroReport_cultureFindingsTable_XR0531M"/>
          </xsl:for-each>
  ...
  <xsl:template name="MicroReport_cultureFindingsTable_XR0531M">
