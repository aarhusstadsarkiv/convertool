...
>
    ...
    <xsl:include href="XSLTs/2021/06/27/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2021/06/06/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2020/06/15/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2020/05/06/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2020/03/30/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2019/12/01/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2019/03/31/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2018/08/06/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2017/08/04/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2017/02/17/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2017/02/15/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2017/05/01/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2016/12/01/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2016/10/02/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2016/04/28/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2015/08/01/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2015/02/16/stylesheet/viewEmessage.xsl"/>
    <xsl:include href="XSLTs/2014/10/08/stylesheet/viewEmessage.xsl"/>
    ...
    <xsl:include href="XSLTs/2011/06/15/stylesheet/viewEmessage.xsl"/>
        ...
        <html>
            ...
            <body>
                ...
                <xsl:if test="$episodeofcareid">
                    <p class="ecareid">Forløbsnr.
                        <span>
                            <xsl:value-of select="$episodeofcareid"/>
                        </span>
                    </p>
                </xsl:if>
    ...
    <xsl:template name="ShowParticipant">
        ...
        <td valign="top">
            <font>
                ...
                <xsl:value-of select="$Participant/*[local-name(.)='PersonInitials']"/>
            </font>
        </td>
        <td valign="top">
            <font>
        ...
        <xsl:for-each select="$Participant/*[local-name(.)='FromLabIdentifier']">
            <td valign="top">
                <font>
                    <xsl:attribute name="color">
                        <xsl:value-of select="$FontColor"/>
    ...
    <xsl:template name="ShowParticipants">
        ...
        <td valign="top" width="100%">
            ...
            <table>
                ...
                <xsl:for-each select="$sender/*[local-name(.)='Examinator']">
                    <tr>
                        <td valign="top">
                            <font>
                                <xsl:attribute name="color">
            ...
            <tr>
                ...
                <td>
                    ...
                    <xsl:if test="*[local-name(.)='SubUrbName']">
                        <xsl:value-of select="*[local-name(.)='SubUrbName']"/>
                        <br/>
                    </xsl:if>
    ...
    <xsl:template mode="general"
                  match="*[local-name(.)='StreetName'] | *[local-name(.)='PostCodeIdentifier'] | *[local-name(.)='DistrictName']">
    </xsl:template>
    ...
    <xsl:template mode="general" match="*[local-name(.)='Consent']">
        <xsl:variable name="Samtykke" select="*[local-name(.)='Given']"/>
        <tr>
            <xsl:if test="translate(substring($Samtykke,1,1),'YNTFtf10','ynynynyn')='n'">
                <td>Samtykke
                    <img src="img/Ikon_Lock.PNG"></img>
                </td>
                <td>Negativt patientsamtykke</td>
            </xsl:if>
            <xsl:if test="translate(substring($Samtykke,1,1),'YNTFtf10','ynynynyn')!='n'">
                <td>Samtykke</td>
                <td>Positivt patientsamtykke</td>
            </xsl:if>
        </tr>
    </xsl:template>
